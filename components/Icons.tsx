...
export const BrainCircuit = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 5a3 3 0 1 0-5.997.47c-1.522.292-2.7 1.632-2.7 3.245a3.7 3.7 0 0 0 .692 2.154A3.71 3.71 0 0 0 4.005 13c0 1.613 1.177 2.953 2.698 3.245A3 3 0 0 0 12 19" />
    <path d="M12 5V2" />
    <path d="M12 19v3" />
    <path d="m6.5 13-3.5 2" />
    <path d="m17.5 13 3.5 2" />
    <path d="m19 13 .003-.003A3.7 3.7 0 0 0 20 10.75c0-1.613-1.177-2.953-2.698-3.245A3 3 0 0 0 12 5" />
...
export const Bug = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const FileCode = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
